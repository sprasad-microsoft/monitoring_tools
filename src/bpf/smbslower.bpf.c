...
/*
 * Exact offsets in 4.18.0-553.el8_10.x86_64's cifs.ko.  The loader only
 * enables these programs for that release when cifs module BTF is absent.
 * They were verified from smb2_mid_entry_alloc and
 * _cifs_mid_q_entry_release disassembly in the signed RHEL 8.10 module.
 */
...
/* Older CIFS implementations release the same kref under this name. */
...
/* SLES 15: release_mid(struct mid_q_entry *mid) */
